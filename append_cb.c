// appends a given sequence to the end of the "CB" aux tag
// for every entry in a BAM file.
...
{
  fprintf(fp, "Usage: appendcb infile outfile val num_threads\n\
e.g. ./appendcb in.bam out.bam NNATG 24\n\
